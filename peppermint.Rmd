...
max_value <- max(c(max(c(spending_bycategory[['Amount']], spending_bycategory[['Budget']]))/monthly_salary + 0.01)*monthly_salary,
                   max(c(spending_bycategory[['Amount']], spending_bycategory[['Budget']])))
